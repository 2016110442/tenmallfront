...
public class SUBMAILUtil {
     ...
     * 手机号
     */
    public static String verificationCodeSMS(String phone) {
        try {
            main(phone);
    ...
    //APPID
    private static final String APPID = "43996";
    //APPKEY
    private static final String APPKEY = "d021be186ff1ef1c88178d6dace1760a";
    //验证码短信内容
    private static String content = "【夜光杯】欢迎您注册，您的注册验证码是"+verificationCode;
    //加密方式
